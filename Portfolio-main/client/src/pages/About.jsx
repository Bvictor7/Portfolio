      ...
      <div className="about-container">
        <div className="about-header">
          ...
          <p className="status-info">
            🎓 En formation CDA (Sept 2025 - Déc 2026) • Disponible en alternance ou en stage
          </p>
        </div>
        ...
        <div className="about-section">
          ...
          <ul>
            <li>
              ...
              <strong> À la recherche d'une alternance  ou d'un stage!</strong>
            </li>
            <li>
              <strong>Développeur Web et Web Mobile ✅</strong><br />
              📅 2024 - Juin 2025 | AFEC Bayonne<br />
              Formation terminée avec succès. Acquisition de compétences solides en développement Front-end et Back-end.
            </li>
          </ul>
        </div>
